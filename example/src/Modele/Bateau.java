...
public class Bateau<index> extends InterfaceGraphiqueBattleship {
	...
	public enum TypeDeBateau {
		PORTE_AVION("porte avion"), DESTROYER("Destroyer"), SOUS_MARIN("sous marin"),
		BATEAU_PATROUILLE("bateau patrouille");
	...
	/* 
	 	**IMPORTANT**
	 	Il faut créer un tableau selon le nombre de case du bateau,et chaque case de ce tableau se fera randomiser
	   un index selon les contrainte qui vont etre implanmentées plus tard,il faut donc trouver une facon de randomiser
	   cet index la  */
